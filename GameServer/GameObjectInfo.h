...
enum class en_GameObjectStatusType : int32
{
	STATUS_ABNORMAL_NONE =								0b0000000000000000,
	STATUS_ABNORMAL_FIGHT_CHOHONE =						0b0000000000000001,
	STATUS_ABNORMAL_FIGHT_SHAEHONE =					0b0000000000000010,
	STATUS_ABNORMAL_PROTECTION_SHIELD_SMASH =			0b0000000000000100,
	STATUS_ABNORMAL_SPELL_ROOT =						0b0000000000001000,
	STATUS_ABNORMAL_SPELL_ICE_CHAIN =					0b0000000000010000,
	STATUS_ABNORMAL_SPELL_ICE_WAVE =					0b0000000000100000,
	STATUS_ABNORMAL_SPELL_LIGHTNING_STRIKE =			0b0000000001000000,
	STATUS_ABNORMAL_DISCIPLINE_ROOT =					0b0000000010000000,
	STATUS_ABNORMAL_ASSASSINATION_BACK_STEP =			0b0000000100000000,
	STATUS_ABNORMAL_ASSASSINATION_WEAPON_POISON =		0b0000001000000000,

	STATUS_ABNORMAL_FIGHT_CHOHONE_MASK =				0b1111111111111110,
	STATUS_ABNORMAL_FIGHT_SHAEHONE_MASK =				0b1111111111111101,
	STATUS_ABNORMAL_PROTECTION_SHIELD_SMASH_MASK =		0b1111111111111011,
	STATUS_ABNORMAL_SPELL_ROOT_MASK =					0b1111111111110111,
	STATUS_ABNORMAL_SPELL_ICE_CHAIN_MASK =				0b1111111111101111,
	STATUS_ABNORMAL_SPELL_ICE_WAVE_MASK =				0b1111111111011111,
	STATUS_ABNORMAL_SPELL_LIGHTNING_STRIKE_MASK =		0b1111111110111111,
	STATUS_ABNORMAL_DISCIPLINE_ROOT_MASK =				0b1111111101111111,
	STATUS_ABNORMAL_ASSASSINATION_BACK_STEP_MASK =		0b1111111011111111,
	STATUS_ABNORMAL_ASSASSINATION_WEAPON_POISON_MASK =	0b1111110111111111
};
...
enum class en_ResourceName : int16
{
	...
	CLIENT_UI_NAME_INVENTORY,
	CLIENT_UI_NAME_INVENTORY_ITEM,
	CLIENT_UI_INVENTORY_ITEM_GAIN,
	CLIENT_UI_PARTY_PLAYER_INFO_FRAME,
	CLIENT_UI_PERSONAL_MESSAGE,
	CLIENT_UI_DAMAGE,
	CLIENT_UI_NAME_EQUIPMENT,
	CLIENT_UI_NAME_SKILL_EXPLANATION,
	CLIENT_UI_NAME_SKILL_ITEM,
	CLIENT_UI_NAME_SKILL_BUF_DEBUF,
	CLIENT_UI_NAME_ITEM_EXPLANATION,
	CLIENT_UI_NAME_CRAFTING_BOX,
	CLIENT_UI_NAME_FURNACE,
	CLIENT_UI_NAME_SAWMILL,
	CLIENT_UI_NAME_ITEM_DIVIDE,
	CLIENT_UI_NAME_OPTION,
	CLIENT_UI_NAME_TILE_BUY,
	CLIENT_UI_NAME_SKILL_ITEM_DRAG,
	CLIENT_UI_NAME_INVENTORY_ITEM_DRAG,
	CLIENT_UI_NAME_QUICK_SLOT_ITEM_DRAG,
	CLIENT_UI_NAME_MY_CHARACTER_HUD,
	CLIENT_UI_NAME_TARGET_HUD,
	CLIENT_UI_NAME_PLAYER_OPTION,
	CLIENT_UI_NAME_PARTY_PLAYER,
	CLIENT_UI_NAME_PARTY_PLAYER_OPTION,
	CLIENT_UI_NAME_PARTY_REACTION,
	CLIENT_UI_NAME_HP_BAR,
	CLIENT_UI_NAME_SPELL_BAR,
	CLIENT_UI_NAME_GATHERING_BAR,
	CLIENT_UI_NAME_NAME,
	CLIENT_UI_NAME_SPEECH_BUBBLE,
...
enum class en_PersonalMessageType : int8
{
	...
	PERSONAL_MESSAGE_SKILL_CANCEL_FAIL_COOLTIME,
	...
	PERSONAL_MESSAGE_EXIST_PARTY_PLAYER,
	PERSONAL_MESSAGE_PARTY_INVITE_REJECT,
	PERSONAL_MESSAGE_PARTY_MAX,
...
{	
	...
	GAMEOBJECT_JOB_TYPE_SKILL_MELEE_ATTACK,		
	...
	GAMEOBJECT_JOB_TYPE_CHANNEL_LEAVE,
