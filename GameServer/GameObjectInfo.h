...
enum class en_SmallItemCategory : int16
{
	...
	ITEM_SMALL_CATEGORY_MATERIAL_COPPER_NUGGET = 2010,
	ITEM_SMALL_CATEGORY_MATERIAL_COPPER_INGOT = 2011,
	ITEM_SMALL_CATEGORY_MATERIAL_IRON_NUGGET = 2012,
	ITEM_SMALL_CATEGORY_MATERIAL_IRON_INGOT = 2013
};
...
enum class en_PersonalMessageType : int8
{
	...
	PERSOANL_MESSAGE_CRAFTING_TABLE_MATERIAL_WRONG_ITEM_INPUT,
...
enum class en_GameObjectJobType : int16
{
	...
	GAMEOBJECT_JOB_CRAFTING_TABLE_ITEM_INPUT,
