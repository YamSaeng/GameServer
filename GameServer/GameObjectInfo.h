...
enum class en_GameObjectType : int16
{
	...
	OBJECT_LEFT_RIGHT_WALL,
	OBJECT_UP_DOWN_WALL,
	OBJECT_UP_TO_LEFT_WALL,
	OBJECT_UP_TO_RIGHT_WALL,
	OBJECT_DOWN_TO_LEFT_WALL,
	OBJECT_DOWN_TO_RIGHT_WALL,
...
enum class en_GlobalMessageType : int8
{
	...
	PERSONAL_MESSAGE_GLOBAL_SKILL_COOLTIME,
